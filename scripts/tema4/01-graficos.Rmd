...
Lo que hace en el siguiente comando es tomar un rango de datos por defecto de $0$ a $1$ para el eje $X$, y graficar esta funcion sobre este rango, ya que se puerde ver en el comando `plot(f)` que solo se se pasa como parámetro la f sin argumentos    
